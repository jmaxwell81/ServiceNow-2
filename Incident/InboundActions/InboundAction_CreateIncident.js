...
if (email_direct.indexOf('broad+DHCP@broadinstitute.org') > -1 || email.subject.indexOf('DHCP') > -1) {
  ...
  if (email.subject.indexOf('DHCP Removal') > -1) {
...
if (email_direct.indexOf('xeroxcww@broadinstitute.org') > -1 ) {
  current.category = "Printing & Documents";
  current.subcategory = "Consumables (Ink/Toner/Wax)";
}
